...
class AlterSentryUsers extends Migration {
	...
	public function up()
	{
		...
		@DB::statement('ALTER TABLE  `users` ADD  `location` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL AFTER  `name`');
		@DB::statement('ALTER TABLE  `users` ADD  `bounds` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL AFTER  `location`');
	}
